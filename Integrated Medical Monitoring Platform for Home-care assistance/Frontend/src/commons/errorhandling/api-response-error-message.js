            ...
            <div>
                ...
                <Modal isOpen={this.state.collapseForm} toggle={this.toggleForm}
                    ...
                    <ModalBody>
                        ...
                        <Row>
                            <Col xs="3"> Resource : </Col>   <Col xs="auto" className={styles.errorText}>{ this.state.error.entity} </Col>
                        </Row>
                        <Row>
                            <Col xs="3"> Error : </Col>   <Col xs="auto" className={styles.errorText}>{ this.state.error.statusCode}  </Col>
                        </Row>
                        <Row>
                            <Col xs="3"> Message : </Col>   <Col xs="auto" className={styles.errorText}>{ this.state.error.statusMessage} </Col>
                        </Row>
                        <Row>
                            <Col xs="3"> Path : </Col>   <Col xs="auto" className={styles.errorText}>{ this.state.error.requestedUri} </Col>
                        </Row>
                        <Row>
